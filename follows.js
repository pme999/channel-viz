(function ( $ ){
	...
	*/
	...
	var defaultKey		= '7B83tSVJnPsrc6OmhOzDePQZeFmv9go8vAmfvHxdbQYn9lkl', // Unique master Xively API key to be used as a default
		defaultFeeds	= [1981386467], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'VERNAISON', // Replaces Xively logo in the header
		...
		dataColor		= 'bf0000', // CSS HEX value of color to represent data (omit leading #)
